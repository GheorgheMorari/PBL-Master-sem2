...
from processing_backend.backend.core.adapters.repositories.repository_registry import RepositoryRegistry
...
def ingest_images_with_ingest_input(ingest_input: IngestInput):
    metadata_repository: MongoDBMetadataRepository = RepositoryRegistry.get_repository(MongoDBMetadataRepository,
