...
- Captioning api http://localhost:8091/docs
- Compressor api http://localhost:8092/docs
- Processing backend api http://localhost:8090/docs

1) http://localhost:8090/api/v1/ingest
   `{
   "image_ids" : ["image_uuid1"],
   "user_ids" : ["user_uuid1"]
   }`

2) http://localhost:8090/api/v1/delete
   `{
   "image_ids" : ["image_uuid1"],
   }`

3) http://localhost:8090/api/v1/query
   `{
   "user_id" : "user_uuid1",
